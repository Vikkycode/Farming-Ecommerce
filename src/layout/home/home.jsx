...
//Assets
import { grains,fruits,vegetables } from "../../assets";
...
const Home = () => {
  ...
  //Helpers
  const image = [
    { title: "Vegetables", image:vegetables , path: ROUTES.VEGETABLES },
    { title: "Fruits", image: fruits, path: ROUTES.FRUITS },
    { title: "Grains", image: grains, path: ROUTES.GRAINS },
  ];
